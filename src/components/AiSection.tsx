...
export default function AiSection({ onOpenModal, schedule }: AiSectionProps) {
...
console.log(schedule, 'schedule');
  ...
  return (
    <>
      <section className='w-full bg-gradient-to-r from-[#0A66C2] to-[#00C2FF] text-white pt-16 pb-[110px] px-4 md:px-10 lg:px-20'>
        {/* Heading */}
        ...
        <div className='mt-14 grid md:grid-cols-2 gap-10 max-w-4xl mx-auto'>
          ...
          <div className='flex gap-4 items-start'>
            ...
            <div>
              ...
              <p className='text-white mt-2'>
                Position yourself as the AI-powered professional or business
                owner who delivers faster, smarter, and premium-quality results.
              </p>
            </div>
          </div>
        </div>
  ...
  '
      ...
      <div
        className={`
          w-full bg-[#111] text-white py-4 px-4 sm:px-20
          transition-all duration-300 z-50
          ${isSticky ? 'fixed bottom-0 left-0 shadow-xl' : 'relative'}
        `}
      >
          ...
          <div>
            <div className='flex items-center gap-3'>
              <p className='text-2xl  font-bold'>
                Free<span className='line-through ml-3'>₹500 </span>
              </p>
            </div>
